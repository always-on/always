...
public class OntologyUserModel implements UserModel{
	...
	public OntologyUserModel(@UserName String userName, OntologyHelper ontology, @UserOntologyLocation File userDataFile, OntologyCalendar calendar, OntologyPeopleManager peopleManager, OntologyPlaceManager placeManager){
	...
	public void save() {
		try {
			...
			OWLOntology userOntology = manager.createOntology(IRI.create("file:"+userDataFile.getPath()));
			...
			manager.saveOntology(userOntology, new OWLFunctionalSyntaxOntologyFormat(), new FileOutputStream(userDataFile));
