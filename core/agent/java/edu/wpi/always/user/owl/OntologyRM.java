...
public class OntologyRM {
	...
	public OWLOntology getOWLOntology () { return ontology; }
	...
	public OntologyRM(String userName){
		...
		try{
            ...
            OWLIndividual toAdd = factory.getOWLNamedIndividual(":"+userName, pm);
	...
	// Add a new person to the ontology, along with their location and relationship to the user
	...
	public void AddPerson(String name, String zip, String relationship){
		...
		axioms.add(new AddAxiom(ontology, factory.getOWLObjectPropertyAssertionAxiom(
	...
	public static void main(String[] args){
		...
		try{
			...
			axioms.add(new AddAxiom(ontology,
					factory.getOWLDeclarationAxiom(place)));
			OWLClass person = factory.getOWLClass(":Person", pm);
			OWLObjectProperty livesIn = factory.getOWLObjectProperty(":LivesIn", pm);
			axioms.add(new AddAxiom(ontology,
					factory.getOWLDeclarationAxiom(livesIn)));
			OWLClass relative = factory.getOWLClass(":Relative", pm);
			axioms.add(new AddAxiom(ontology, 
					factory.getOWLSubClassOfAxiom(relative, person)));
			OWLClass child = factory.getOWLClass(":Child", pm);
			axioms.add(new AddAxiom(ontology, 
					factory.getOWLSubClassOfAxiom(child, relative)));
			OWLClass grandchild = factory.getOWLClass(":Grandchild", pm);
			axioms.add(new AddAxiom(ontology, 
					factory.getOWLSubClassOfAxiom(grandchild, relative)));
			OWLClass sibling = factory.getOWLClass(":Sibling", pm);
			axioms.add(new AddAxiom(ontology, 
					factory.getOWLSubClassOfAxiom(sibling, relative)));
			OWLClass user = factory.getOWLClass(":User", pm);
			axioms.add(new AddAxiom(ontology, 
					factory.getOWLSubClassOfAxiom(user, person)));
			OWLClass friend = factory.getOWLClass(":Friend", pm);
			axioms.add(new AddAxiom(ontology, 
					factory.getOWLSubClassOfAxiom(friend, person)));
