...
public abstract class OntologyCardinality {
   ...
   public static OntologyCardinality exactly (final int num) {
      return new OntologyCardinality() {
         ...
         @Override
         public OWLDataCardinalityRestriction getDataCardinality (
               OWLDataFactory factory, OWLDataPropertyExpression property,
               OWLDataRange dataRange) {
            return factory.getOWLDataExactCardinality(num, property, dataRange);
         }

         @Override
         public OWLObjectCardinalityRestriction getObjectCardinality (
               OWLDataFactory factory, OWLObjectPropertyExpression property,
   ...
   public abstract OWLDataCardinalityRestriction getDataCardinality (
         OWLDataFactory factory, OWLDataPropertyExpression property,
         OWLDataRange dataRange);

   public abstract OWLObjectCardinalityRestriction getObjectCardinality (
         OWLDataFactory factory, OWLObjectPropertyExpression property,
         OWLClassExpression range);
}
