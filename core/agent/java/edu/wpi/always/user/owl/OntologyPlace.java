...
public class OntologyPlace implements Place {
	...
	public String getCityName(){
		String name = owlPlace.getDataPropertyValue(CITY_NAME_PROPERTY).asString();
		if(name!=null)
			return name;
		return getZip();
	}
	public DateTimeZone getTimeZone(){
		return DateTimeZone.forID(owlPlace.getDataPropertyValue(TIMEZONE_PROPERTY).asString());
	}
