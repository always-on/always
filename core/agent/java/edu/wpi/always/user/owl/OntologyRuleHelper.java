...
public class OntologyRuleHelper extends OntologyHelper{
	...
	public SWRLObjectPropertyAtom getSWRLObjectPropertyAtom(OWLObjectPropertyExpression property, SWRLIArgument individual, SWRLIArgument value){
		return getFactory().getSWRLObjectPropertyAtom(property, individual, value);
	}
	public SWRLDataPropertyAtom getSWRLDataPropertyAtom(OWLDataPropertyExpression property, SWRLIArgument individual, SWRLDArgument value){
	...
	public SWRLRule getSWRLRule(SWRLAtom antecedent, Set<? extends SWRLAtom> consequent){
		return getSWRLRule(Collections.singleton(antecedent), consequent);
	}
	public SWRLRule getSWRLRule(Set<? extends SWRLAtom> antecedent, SWRLAtom consequent){
	...
	public SWRLRule isARule(OWLObjectProperty antecedentProperty, OWLObjectProperty consequentProperty){
	...
	public SWRLRule isARule(OWLObjectProperty antecedentProperty, OWLClassExpression antecedentClass, OWLObjectProperty consequentProperty){
		SWRLVariable varA = getSWRLVariable("varA");
		SWRLVariable varB = getSWRLVariable("varB");
	...
	public SWRLRule isARule(OWLObjectProperty antecedentProperty, OWLClassExpression consequentClass){
		SWRLVariable varA = getSWRLVariable("varA");
		SWRLVariable varB = getSWRLVariable("varB");
		return getSWRLRule(
				getSWRLObjectPropertyAtom(antecedentProperty, varA, varB),
	...
	public SWRLRule hasARule(OWLObjectProperty antecedentProperty, OWLObjectProperty consequentProperty){
		SWRLVariable varA = getSWRLVariable("varA");
		SWRLVariable varB = getSWRLVariable("varB");
		return getSWRLRule(
				getSWRLObjectPropertyAtom(antecedentProperty, varA, varB),
	...
	/**
	 * If B is property of A and C is property of B and A is not C then C is property of A
	 * 
	 * @param property
	 * @return
	 */
	...
	public SWRLRule isBidirectionalRule(OWLObjectProperty property){
		...
		SWRLVariable varB = getSWRLVariable("varB");
		return getSWRLRule(
				getSWRLObjectPropertyAtom(property, varA, varB),
