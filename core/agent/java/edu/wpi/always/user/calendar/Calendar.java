...
public interface Calendar {
	 ...
	 * 
	 * @param entry
	 *            The Calendar Entry to be added to the calendar
	 ...
	 * 
	 * @param start
	 *            the beginning of the time period to search
	 * @param end
	 ...
	 *            the interval to search, if the interval is null all events will be returned
	 * @return a list of entries sorted by start time
	 */
