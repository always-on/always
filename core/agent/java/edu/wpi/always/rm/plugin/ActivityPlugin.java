...
public abstract class ActivityPlugin {
   ...
   // translate task stuff to relationship stuff? to what degree? how
   // task-specific is this?
   // the Activity ClientPlugin is stored somewhere by the program performing
   // the activity. It uses
