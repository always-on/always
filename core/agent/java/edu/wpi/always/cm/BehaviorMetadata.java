...
public class BehaviorMetadata {
	...
	public BehaviorMetadata (double specificity, double dueIn, double timeRemaining,
			boolean newActivity, boolean isContainer, boolean goodInterruptMoment, double timeActive) {
