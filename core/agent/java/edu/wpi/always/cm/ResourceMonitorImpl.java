...
public class ResourceMonitorImpl implements ResourceMonitor, PrimitiveBehaviorControlObserver {
	...
	public boolean allDone (List<PrimitiveBehavior> primitiveBehaviors,
		...
		List<PrimitiveBehavior> p = new ArrayList<PrimitiveBehavior>(primitiveBehaviors);
