...
public class PrimitiveBehaviorControlDisconnectableWrapper implements PrimitiveBehaviorControl, PrimitiveBehaviorControlObserver {
	private final PrimitiveBehaviorControl inner;
	private final CopyOnWriteArrayList<PrimitiveBehaviorControlObserver> observers =
			new CopyOnWriteArrayList<PrimitiveBehaviorControlObserver>();
	private boolean disconnected;

	public PrimitiveBehaviorControlDisconnectableWrapper(PrimitiveBehaviorControl inner) {
		this.inner = inner;
	...
	private PrimitiveRealizerHandle canceledRealizerHandle(final PrimitiveBehavior behavior) {
