...
public class Place implements Runnable {
	...
	/**
	 * If the Place gets activated, its execute will not be called
	 * automatically. In this way, an "runner" of the PetriNet can decide, for
	 * example, to execute it on another thread. Feel free to block the thread
	 * during execution
	 * 
	 * @param transition
	 */
