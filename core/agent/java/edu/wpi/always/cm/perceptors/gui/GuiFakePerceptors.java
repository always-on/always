...
public class GuiFakePerceptors extends JFrame {
	...
	public MovementPerceptor createMovementPerceptor() {
		return new GuiFakeMovementPerceptor(txtMoveX, txtMoveY);
	}

	public FacePerceptor createFacePerceptor() {
		return new GuiFakeFacePerceptor(txtFaceX, txtFaceY);
	}
