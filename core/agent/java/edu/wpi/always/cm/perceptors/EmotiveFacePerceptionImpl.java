...
public class EmotiveFacePerceptionImpl implements EmotiveFacePerception {
	...
	public boolean isNear() {
		...
		//System.out.println(new Point((getRight()+getLeft())/2, (getBottom()+getTop())/2));
		
		return (getRight()-getLeft())>FACE_NEAR_WIDTH_THRESHOLD || (getBottom()-getTop())>FACE_NEAR_HEIGHT_THRESHOLD;
	}
