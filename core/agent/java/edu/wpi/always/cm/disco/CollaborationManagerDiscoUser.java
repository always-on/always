...
public class CollaborationManagerDiscoUser extends Actor {

	public CollaborationManagerDiscoUser (String name) {
		super(name);
	      ...
	      new ProposeShouldNotPlanSpecificPlugin(this, agenda, 5);
