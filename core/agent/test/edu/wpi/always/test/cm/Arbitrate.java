...
public class Arbitrate {
	private static class Parameters {
		...
		public BehaviorMetadata toMetadata() {
			return new BehaviorMetadata(specificity, dueIn, timeRemaining, newActivity, isContainer, goodInterruptMoment, timeActive);
		}
	}
	...
	private boolean checkSwitching(boolean checkReverse) {
		...
		if (checkReverse) {
			if (shouldSwitch && shouldSwitch(o, f, true)) {
				...
				System.out.println("UNSTABLE switch! Information about the reverse case follows:");
	...
	private boolean shouldSwitch(BehaviorMetadata f, BehaviorMetadata o, boolean silent) {
	...
	public void bothHaveSpecificityAndAreDueInWithRemainingTime(double specificity, double dueIn, double timeRemaining) {
