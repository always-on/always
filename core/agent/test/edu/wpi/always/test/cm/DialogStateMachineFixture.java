...
public class DialogStateMachineFixture {
	...
	public void setUp() {
		...
		subject = new OldDialogStateMachine(resourceMonitor, contentProvider, menuPerceptor);
	}
	...
	public void afterSay_ShouldShowUserChoices() {
		...
		for(int i = 0; i < 10; i++) {
			...
			if(i == 5)
				resourceMonitor.done = true; // should return the menu even after they're shown once
	...
	public void testBackAndForthTwice() {
		...
		contentProvider.userChoices = Lists.newArrayList("Bet you're happy", "Okay");
		resourceMonitor.done = true;
	...
	private void whenTheresNoChoiceForUserTriesSay_IfThereIsSomethingToSay_ShouldStayInHearState(boolean trueForNull_falseForEmptyList) {
		contentProvider.userChoices = trueForNull_falseForEmptyList ? null : new ArrayList<String>();
