...
public class PrimitiveRealizerFactory implements IPrimitiveRealizerFactory {

   private final PicoContainer container;
   private final HashMap<Class<?>, Constructor<?>> constructors = new HashMap<Class<?>, Constructor<?>>();

   public PrimitiveRealizerFactory (PicoContainer container) {
   ...
   private List<Class<? extends PrimitiveRealizer<? extends PrimitiveBehavior>>> findAllRealizers () {
      ...
      for (ComponentAdapter<PrimitiveRealizer> r : registered) {
         ...
         Class<? extends PrimitiveRealizer<? extends PrimitiveBehavior>> t = (Class<? extends PrimitiveRealizer<? extends PrimitiveBehavior>>) r
