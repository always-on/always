...
public class StartGamingSequence extends SrummyAdjacencyPairImpl {
   ...
   private static boolean receivedMoveOptions = false;
   ...
   @Override
   public void agentMoveOptionsReceived () {
