...
public class CommentingHandler {
	...
	public Comment pickCommentOnOwnMove(GameLogicState gameState, 
			Scenario currentScenario, AnnotatedLegalMove move, int who){
...
//					eligibleComments.add(cm);
		...
		//moments
		if(currentScenario.reportCommentingTagsForTheCurrentProgress(currentScenario.tellProgress()) != null)
			currentMomentsTags.addAll(currentScenario.reportCommentingTagsForTheCurrentProgress(currentScenario.tellProgress()));
...
//				eligibleComments.add(each.getKey());
	...
	public void make(Comment cm) throws EngineException, 
	AudioException, IllegalArgumentException, InterruptedException{
		tts.say(cm.getContent());
	}
	
	//testing main
	public static void main(String[] args) {
		CommentingHandler ch = new CommentingHandler();
