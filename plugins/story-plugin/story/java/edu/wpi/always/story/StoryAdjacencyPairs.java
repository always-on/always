...
public class StoryAdjacencyPairs {
	...
	private static String storyNameToSave, storyNameToPlayOrEdit, storyMood, storyReplayMoodChoice, storyAudience = "";
	private static OntologyStory[] storyList;

	public static class StoryStartAdjacencyPair extends AdjacencyPairImpl<StoryStateContext>{
		public StoryStartAdjacencyPair(final StoryStateContext context) {
			super("Do you want to listen to a story you told me before or to tell me a new one?", context);
			...
			choice("See story list to listen or edit", new DialogStateTransition() {
				@Override
				public AdjacencyPair run() {
	...
	public static class StoryRecordingAdjacencyPair extends AdjacencyPairImpl<StoryStateContext>{
...
//			SchemaImplBase.backchanneling = true;
	...
	public static class StoryReplayAdjacencyPair extends AdjacencyPairImpl<StoryStateContext>{
	...
	public static class StoryRecordDoneGetAttitudeAdjacencyPair extends AdjacencyPairImpl<StoryStateContext>{
		public StoryRecordDoneGetAttitudeAdjacencyPair(final StoryStateContext context) {
			super("Could you tell me if it was a happy story, neutral or sad one?", context);
	...
	public static class StoryRecordDoneGetAudienceAdjacencyPair extends AdjacencyPairImpl<StoryStateContext>{
		public StoryRecordDoneGetAudienceAdjacencyPair(final StoryStateContext context) {
			super("Was this story meant for someone? If yes, tell me who?", context);
	...
	public static class StoryRecordDoneSaveOntologyAdjacencyPair extends AdjacencyPairImpl<StoryStateContext>{
		public StoryRecordDoneSaveOntologyAdjacencyPair(final StoryStateContext context) {
		...
		public void enter(){
			getContext().getStoryManager().addStory(storyMood, storyNameToSave, storyAudience);
		}
	}
	public static class EnterAudienceName extends KeyboardAdjacenyPair<StoryStateContext> {
		
		public EnterAudienceName(StoryStateContext context) {
			super("Type his or her name, I will remember.", context, context.getKeyboard());
		}
	...
	public static class EnterStoryNameToRecord extends KeyboardAdjacenyPair<StoryStateContext> {

		public EnterStoryNameToRecord(StoryStateContext context) {
			super("What do you want the name of it to be?", context, context.getKeyboard());
		}
	...
	public static class StoryReplayStoryTypeChoiceAdjacencyPair extends AdjacencyPairImpl<StoryStateContext>{
		public StoryReplayStoryTypeChoiceAdjacencyPair(final StoryStateContext context) {
	...
	public static class StoryReplayShowStoriesAdjacencyPair extends AdjacencyPairImpl<StoryStateContext>{
		public StoryReplayShowStoriesAdjacencyPair(final StoryStateContext context) {
			super("I remember these:", context);
			for(final OntologyStory storyInstance : storyList)
				if(storyInstance.getAttitude().contains(storyReplayMoodChoice) || storyReplayMoodChoice.equals("all"))
	...
	public static class StoryReplayEditOneStory extends AdjacencyPairImpl<StoryStateContext>{
		public StoryReplayEditOneStory(final StoryStateContext context) {
			super("Do you want to play it, edit the name or just delete it?", context);
	...
	public static class EnterStoryNameToPlay extends KeyboardAdjacenyPair<StoryStateContext> {
