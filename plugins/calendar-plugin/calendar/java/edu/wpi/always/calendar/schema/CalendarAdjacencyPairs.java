...
abstract class CalendarAdjacencyPairs {
   ...
   static abstract class EventTypeAdjacencyPair extends
         CalendarAdjacencyPairImpl {

      public EventTypeAdjacencyPair (final CalendarStateContext context) {
         super("What type of event is it?", context, true);
         for (final CalendarEntryType type : CalendarEntryTypeManager.Types
               .values()) {
         ...
         choice("Something else", new DialogStateTransition() {
            ...
            @Override
            public AdjacencyPair run () {
               return new EventCustomTypeAdjacencyPair(context,
   ...
   static abstract class EventPersonAdjacencyPair extends
         CalendarAdjacencyPairImpl {
   ...
   public static class EventCustomTypeAdjacencyPair extends
      ...
      public EventCustomTypeAdjacencyPair (CalendarStateContext context,
            EventTypeAdjacencyPair pair) {
   ...
   public abstract static class EventDayAdjacencyPair extends
         CalendarAdjacencyPairImpl {

      private final LocalDate start;

      public EventDayAdjacencyPair (String weekQuestion,
            final CalendarStateContext context, final LocalDate start) {
         ...
         choice("yes, it's this week", new DialogStateTransition() {
            ...
            @Override
            public AdjacencyPair run () {
               return new EventWeekDayAdjacencyPair(EventDayAdjacencyPair.this,
                     context, start);
            }
         });
         ...
         choice("no, it's in the future", new DialogStateTransition() {
            ...
            @Override
            public AdjacencyPair run () {
               return new EventMonthDayAdjacencyPair(
                     EventDayAdjacencyPair.this, context, start.plusWeeks(2));
            }
         });
      }
   ...
   public static class EventWeekDayAdjacencyPair extends
         CalendarAdjacencyPairImpl {

      private final LocalDate week;

      public EventWeekDayAdjacencyPair (EventDayAdjacencyPair pair,
            final CalendarStateContext context, final LocalDate week) {
      ...
      private DialogStateTransition transitionTo (
            final EventDayAdjacencyPair pair, final LocalDate d) {
   ...
   public static class EventMonthDayAdjacencyPair extends
         CalendarAdjacencyPairImpl {
      ...
      public EventMonthDayAdjacencyPair (final EventDayAdjacencyPair pair,
         ...
         choice("next month", new DialogStateTransition() {
            ...
            @Override
            public AdjacencyPair run () {
               return new EventMonthDayAdjacencyPair(pair, context, month
                     .plusMonths(1));
            }
         });
      }
   ...
   public abstract static class TimeAdjacencyPair extends
         CalendarAdjacencyPairImpl {

      private static final int TIME_INCREMENT = 15;// minutes
      private static final int NUM_TIMES = 8;

      public TimeAdjacencyPair (final String question,
         ...
         choice("Earlier", new DialogStateTransition() {
            ...
            @Override
            public AdjacencyPair run () {
               return changeStartTime(startTime.minusMinutes(NUM_TIMES
                  * TIME_INCREMENT));
            }
         });
         ...
         choice("Later in the day", new DialogStateTransition() {
            ...
            @Override
            public AdjacencyPair run () {
               return changeStartTime(startTime.plusMinutes(NUM_TIMES
                  * TIME_INCREMENT));
            }
         });
      }
